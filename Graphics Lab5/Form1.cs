...
namespace Graphics_Lab5
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            string[] year = new string[8] { "2013", "2014", "2015","2016", "2017", "2018", "2019", "2020"};
            // Задаем значения элементов массива заработных плат
            int[] value = new int[8] { 1218, 1218, 1378, 1600, 3200, 3723, 4173, 5000 };
            ...
            Image img = Image.FromFile(@"C:\Users\MSI\Desktop\img.bmp", true);
